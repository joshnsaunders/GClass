...
document.getElementById("header2-btn").addEventListener("click", function(){
  document.getElementById("header2-message").innerHTML = "Button 2 click";
});
...
document.getElementById("pats").innerHTML = "Pats beat the Texans";
document.getElementById("chiefs").innerHTML = "Chiefs beat the Steelers";
document.getElementById("falcons").innerHTML = "Falcons beat the Seahawks";
